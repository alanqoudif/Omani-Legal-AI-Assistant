...
st.markdown("---")
if st.session_state.language == "English":
    st.markdown("Omani Legal AI Assistant © 2023 | Powered by Nuqta AI and LangChain")
else:  # Arabic
    st.markdown("مساعد الذكاء الاصطناعي القانوني العماني © 2023 | مدعوم من Nuqta AI و LangChain")
